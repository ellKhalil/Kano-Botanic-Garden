...
class Tbay_PostType_Megamenu {
  	...
  	public static function register_post_type() {
	    $labels = array(
			'name'                  => esc_html__( 'Tbay Megamenu', 'tbay-framework' ),
			'singular_name'         => esc_html__( 'Megamenu', 'tbay-framework' ),
			'add_new'               => esc_html__( 'Add New Mega Menu', 'tbay-framework' ),
			'add_new_item'          => esc_html__( 'Add New Mega Menu', 'tbay-framework' ),
			'edit_item'             => esc_html__( 'Edit Mega Menu', 'tbay-framework' ),
			'new_item'              => esc_html__( 'New Mega Menu', 'tbay-framework' ),
			'all_items'             => esc_html__( 'All Tbay Mega Menu', 'tbay-framework' ),
			'view_item'             => esc_html__( 'View Mega Menu', 'tbay-framework' ),
			'search_items'          => esc_html__( 'Search Mega Menu', 'tbay-framework' ),
			'not_found'             => esc_html__( 'No Mega Menu found', 'tbay-framework' ),
			'not_found_in_trash'    => esc_html__( 'No Mega Menu found in Trash', 'tbay-framework' ),
			'parent_item_colon'     => '',
			'menu_name'             => esc_html__( 'Tbay Mega Menu', 'tbay-framework' ),
	    );
