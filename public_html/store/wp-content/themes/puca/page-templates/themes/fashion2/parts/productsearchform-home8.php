			...
			<div class="form-group">
				<div class="input-group">
					<?php if ( puca_tbay_get_config('search_type') != 'all' && puca_tbay_get_config('search_category') ): ?>
				  	...
				  	<?php endif; ?>
				  		<input data-style="style1 home5 home8" type="text" placeholder="<?php esc_attr_e( 'Search for product...', 'puca' ); ?>" name="s" required oninvalid="this.setCustomValidity('<?php esc_html_e('Enter at least 2 characters', 'puca'); ?>')" oninput="setCustomValidity('')" class="tbay-search form-control input-sm"/>
