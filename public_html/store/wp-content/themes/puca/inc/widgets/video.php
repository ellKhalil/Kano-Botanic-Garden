...
class puca_Tbay_Featured_Video_Widget extends Tbay_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php esc_html_e('Video link:', 'puca' ); ?></label>
            <br>
            ...
            <br>
            <?php esc_html_e('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'puca' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php esc_html_e('Video name:', 'puca' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width')); ?>"><?php esc_html_e('Video width:', 'puca'); ?></label>
            <br>
