<?php	
require get_theme_file_path('inc/merlin-data/wpbakery.php');
require get_theme_file_path('inc/merlin-data/elementor.php');
...
- - - - - - - - - - - - - - - - - - - - */";
	...
	public function set_demo_menus_fashion3() {
		$main_menu       	= get_term_by( 'name', 'Main Menu', 'nav_menu' );
		$topmenu   			= get_term_by( 'name', 'Top Menu', 'nav_menu' );
		$nav_account   		= get_term_by( 'name', 'Nav Account', 'nav_menu' );
	...
	private function import_files_wpb_vc(){
		...
		$mvx  				= $data->import_files_wpb_vc_smarket_mvx();
		$wcfm  				= $data->import_files_wpb_vc_smarket_wcfm();
		$wcvendors  		= $data->import_files_wpb_vc_smarket_wcvendors();
		$rtl  				= $data->import_files_wpb_vc_smarket_rtl();

		return array_merge($import, $fashion_v1, $fashion_v2, $smarket_v1, $smarket_v2, $furniture, $rtl, $dokan, $mvx, $wcfm, $wcvendors);
	}
	...
	private function import_files_elementor(){
		...
		$fashion_v3 = $data->import_files_wpb_el_fashion_v3();
		...
		$mvx  				= $data->import_files_wpb_el_smarket_mvx();
		$wcfm  				= $data->import_files_wpb_el_smarket_wcfm();
		$wcvendors  		= $data->import_files_wpb_el_smarket_wcvendors();
		$rtl  				= $data->import_files_wpb_el_smarket_rtl();

		return array_merge($import, $fashion_v1, $fashion_v3, $fashion_v2, $smarket_v1, $smarket_v2, $furniture, $rtl, $dokan, $mvx, $wcfm, $wcvendors);
	}
