...
if (! defined('ABSPATH') || function_exists('Puca_Elementor_Menu_Vertical')) {
...
class Puca_Elementor_Menu_Vertical extends Puca_Elementor_Widget_Base
{
    public function get_name()
    {
        return 'tbay-fashion3-menu-vertical';
    }

    public function get_title()
    {
        return esc_html__('Puca Menu Vertical', 'puca');
    }
    ...
    protected function style_menu_vertical()
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Style Menu Vertical', 'puca'),
...
$widgets_manager->register(new Puca_Elementor_Menu_Vertical());
