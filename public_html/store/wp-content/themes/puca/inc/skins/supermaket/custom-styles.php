...
if ( !function_exists ('puca_tbay_default_theme_primary_color') ) {
	function puca_tbay_default_theme_primary_color() {
		...
		$theme_variable['main_color'] 			    	= '#ff2d55';

		$theme_variable['main_color2'] 					= '#5856d6';
...
if ( !function_exists ('puca_tbay_default_theme_primary_fonts') ) {
	function puca_tbay_default_theme_primary_fonts() {
		...
		$theme_variable['main_font'] 			    	= 'Open Sans';
...
if (!function_exists('puca_tbay_theme_primary_color')) {
    function puca_tbay_theme_primary_color()
    {
        ...
        $main_color2                    = puca_tbay_get_config(('main_color2'),$default['main_color2']);
        ...
        :root {
            ...
            --tb-theme-color-darken: <?php puca_check_empty_customize( puca_tbay_color_lightens_darkens($main_color, -0.15), puca_tbay_color_lightens_darkens($default['main_color'], -0.15) ); ?>;
  
        	--tb-theme-color-second: <?php puca_check_empty_customize( $main_color2, $default['main_color2'] ); ?>;

        	--tb-theme-color-second-darken: <?php puca_check_empty_customize( puca_tbay_color_lightens_darkens($main_color2, -0.15), puca_tbay_color_lightens_darkens($default['main_color2'], -0.15) ); ?>;
        } 
        <?php
    }
}
