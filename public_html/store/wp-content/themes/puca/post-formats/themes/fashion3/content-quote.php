	        	...
	        	<div class="entry-header">
					...
					<div class="meta-info">
						...
						<?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
							<span class="comments-link"><?php comments_popup_link( esc_html__('0 comment', 'puca'), esc_html__('1 comment', 'puca'), esc_html__( '% comments', 'puca' ) ); ?><?php esc_html_e('comments', 'puca') ?></span>
						<?php endif; ?>
				...
				<div class="post-excerpt entry-content">
					<?php
						if ( has_excerpt()) {
							...
							echo '<blockquote>';
							?>
								<div class="entry-description"><?php echo puca_tbay_substring(get_the_content(), 25, '...' ); ?> <a href="<?php the_permalink(); ?>" title="<?php esc_attr_e( 'Continue reading', 'puca' ); ?>"><?php esc_html_e( 'Continue reading', 'puca' ); ?><i class="icon-arrow-right-circle icons"></i></a></div>
							<?php
							echo '</blockquote>';
						}
					?>
			...
			if ( has_excerpt()) {
				...
				?>
					<div class="entry-description">
						...
						<div class="more">
							<a href="<?php the_permalink(); ?>" title="<?php esc_attr_e( 'Continue reading', 'puca' ); ?>"><?php esc_html_e( 'Continue reading', 'puca' ); ?> <i class="icon-arrow-right icons"></i></a>
						</div>
					</div>
				<?php
				echo '</blockquote>';
