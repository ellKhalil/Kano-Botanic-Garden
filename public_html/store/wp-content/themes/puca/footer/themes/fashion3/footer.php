					...
					<div class="container">
						<div class="copyright-content">
							...
							<?php
									...
									echo wp_kses(__('Copyright &copy; 2022 - puca. All Rights Reserved. <br/> Powered by <a href="//thembay.com">ThemBay</a>', 'puca'), $allowed_html_array);
	...
	if ( puca_tbay_get_config('back_to_top') ) { ?>
		<div class="tbay-to-top <?php echo esc_attr($tbay_header); ?>">
			...
			<div class="more-to-top">
				...
				<a class="text-skin wishlist-icon" href="<?php $wishlist_url = YITH_WCWL()->get_wishlist_url(); echo esc_url($wishlist_url); ?>"><i class="tb-icon tb-icon-zz-heart" aria-hidden="true"></i><span class="count_wishlist"><?php $wishlist_count = YITH_WCWL()->count_products(); echo esc_html($wishlist_count); ?></span></a>
				<?php } ?>
