					...
					<?php if (wc_coupons_enabled()) { ?>
						<div class="coupon pull-left">
							<div class="box">
								...
								<input type="submit" class="btn btn-default<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' '.wc_wp_theme_get_element_class_name('button') : ''); ?>" name="apply_coupon" value="<?php esc_attr_e('Apply', 'puca'); ?>" />
							</div>
