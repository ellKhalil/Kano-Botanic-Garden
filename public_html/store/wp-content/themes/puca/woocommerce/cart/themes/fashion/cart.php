		...
		<div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
			...
			<div class="cart-bottom actions">
				<div class="clearfix">
					...
					<?php do_action('woocommerce_cart_actions_free_shipping'); ?>

					<?php if (wc_coupons_enabled()) { ?>
						<div class="coupon pull-left">
							<div class="box">
								<label for="coupon_code" class="screen-reader-text"><?php esc_html_e('Coupon:', 'puca'); ?></label> 
								<input type="text" name="coupon_code" id="coupon_code" value="" class="text" placeholder="<?php esc_attr_e('Enter coupon code', 'puca'); ?>" />
								<input type="submit" class="btn btn-default<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' '.wc_wp_theme_get_element_class_name('button') : ''); ?>" name="apply_coupon" value="<?php esc_attr_e('Apply', 'puca'); ?>" /></div>
					...
					<div class="pull-right update">
						<input type="submit" class="btn btn-default <?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' '.wc_wp_theme_get_element_class_name('button') : ''); ?>" name="update_cart" value="<?php esc_attr_e('Update Cart', 'puca'); ?>" />
