    ...
    <?php while ($loop->have_posts()) : $loop->the_post(); global $product;?>
        ...
        <div class="item">
			...
			<?php 
                ...
                wc_get_template('item-product/themes/fashion3/inner.php', array('flash_sales' => $flash_sales, 'end_date' => $end_date, 'countdown_title' => $countdown_title, 'countdown' => $countdown)); 
            ?>
			</div>
        </div>
