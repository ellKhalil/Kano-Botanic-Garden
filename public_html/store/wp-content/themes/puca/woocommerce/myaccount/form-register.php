	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		...
		<form method="post" class="register widget" role="form" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<?php else : ?>
				...
				<p><?php esc_html_e( 'A link to set a new password will be sent to your email address.', 'puca' ); ?></p>
			...
			<p class="woocommerce-form-row form-row form-group">
				...
				<button type="submit" class="woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="register" value="<?php esc_attr_e( 'Register', 'puca' ); ?>"><?php esc_html_e( 'Register', 'puca' ); ?></button>
			</p>
