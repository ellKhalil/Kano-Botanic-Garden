...
<div class="product-block list" data-product-id="<?php echo esc_attr($product->get_id()); ?>">
	<div class="row">
		<div class="col-sm-5 col-md-3 list-img">
		    <figure class="image">
	    ...
	    <div class="col-sm-7 col-md-9 list-content">
	    	<?php 
                        ...
                        <?php do_action( 'puca_loop_item_quantity' ); ?>
				            ...
				            <?php if( class_exists( 'YITH_Woocompare' ) ) { ?>
				                ...
				                <div class="yith-compare">
		                            <a href="<?php echo wp_nonce_url( add_query_arg( $url_args ), $action_add ); ?>" title="<?php echo esc_attr__('Compare', 'puca'); ?>" class="compare" data-product_id="<?php echo esc_attr($product->get_id()); ?>">
										<i class="tb-icon tb-icon-zz-compare"></i>
		                            </a>
				                </div>
				            <?php } ?> 
