        ...
        <div class="caption">
            ...
            <div class="stock">
				...
				<?php if($stock_quantity > 0) { ?>
					<span class="tb-stock"><?php esc_html_e('Avaiable', 'puca'); ?> : <?php echo esc_html($stock_quantity); ?></span>
					<span class="tb-sold"><?php esc_html_e('Sold', 'puca'); ?> : <?php echo esc_html($total_sales); ?></span>
				<?php } else { ?>
					<span class="tb-sold"><?php esc_html_e('Sold out', 'puca'); ?></span>
				<?php } ?>
                <div class="progress">
