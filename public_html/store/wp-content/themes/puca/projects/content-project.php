...
<div <?php post_class($classes); ?> data-groups='[<?php echo esc_attr($datagroup); ?>]'>
	...
	<div class="work-overlay">
		<div class="project-icons">
			<div class="project-icon"><a class="lightbox-gallery" href="<?php echo esc_url($large_image_url[0]); ?>" title="<?php esc_attr_e('Zoom Image', 'puca'); ?>"><i class="fa fa-search"></i></a></div>
			<div class="project-icon"><a class="link-project" href="<?php the_permalink(); ?>" title="<?php esc_attr_e('Portfolio Single', 'puca'); ?>"><i class="fa fa-link"></i></a></div>
		</div>
	</div>
